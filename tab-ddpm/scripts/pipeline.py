    ...
    if args.train:
        train(
            ...
            **raw_config['diffusion_params'],
            ...
            constraint_regularization=raw_config['train'].get('constraint_regularization', None),
            distribution_regularization=raw_config['train'].get('distribution_regularization', None),
